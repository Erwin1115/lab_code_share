from utils_NPMML import CSP_PA, Precision, num_of_client
import numpy as np
N = num_of_client
...
def calculate_parameters(received_parameters, A_Matrix_):
    ...
    de_to_Wh1 = CSP_PA.decryMatrix(to_Wh_1)
    # print("Before multiple invertible matrix")
    de_to_Wh1 = (de_to_Wh1 @ A_Matrix_.T)
    # TODO Decrypt C2 with CSP. Remember to decrypt in CSP.
    
    # print("Before Decrypting to_Wh_2")
