...
from DataShare_NPMML import load_data, load_enc_data, decrypt_matrix
from utils_NPMML import sigmoid,R
from utils_NPMML import Gama_, Gama, Precision
from utils_NPMML import CSP_PA, mod_pow, num_of_client
...
class ES:
    ...
    def forward_prop(self, parameters):
        ...
        print("Forwarding 9-1 finished")
        # TODO Encrypt C2 with CSP. Remember to decrypt in CSP.
        C2 = CSP_PA.encryMatrix(C2)
        print("Forwarding 9-2 finished")
